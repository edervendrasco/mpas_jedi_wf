...
declare -a inpbuf=("1bamua" "satwnd" )
declare -a lnkbuf=("amsua"  "satwnd" )
...
do
  ...
  inpname=${inpbuf[$i]}
  lnkname=${lnkbuf[$i]}
  ln -sfv $ncep_ext/$yy/$mm/$dd/gdas.t${hh}z.${inpname}.tm00.bufr_d ./${lnkname}.bufr
